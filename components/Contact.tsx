      ...
      <div className="container px-4 md:px-6 ">
        ...
        <div className="flex justify-center space-x-8">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground border-2 border-muted-foreground hover:border-white  p-2 rounded-full hover:bg-black hover:text-white transition-colors"
          >
            <FaXTwitter size={32} />
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground border-2 border-muted-foreground hover:border-white   p-2 rounded-full hover:bg-[#0077B5] hover:text-white transition-colors"
          >
